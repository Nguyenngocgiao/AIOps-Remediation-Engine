...
### Run a single incident evaluation(e.g., E01) by pointing the engine to the live incident data, the historical corpus, and the actions catalog. The engine will output its decision in JSON format to standard output.
